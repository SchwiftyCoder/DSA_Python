...
class ArrayQueue:
    ...
    def __init__(self) -> None:
        """create a queue object with default capacity, front and rear set to an initial value of 0"""
    ...
    def __len__(self) -> int:
        """returns the size of the queue. this also refers to the index of the currevtn enqueue operation"""
        return self._size
    ...
    def enqueue(self, element) -> None:
        """add an elenent to the queue else raise exception if queue is full"""
    ...
    def __str__(self) -> str:
        """display only elements that are not None"""
